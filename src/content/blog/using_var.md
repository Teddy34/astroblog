...
description: "REPL In JavaScript"
pubDate: "2019-07-26"
heroImage:  "/canigou_flat.jpg"
---
...
![first access to geojson.io](/using_var/geojsonio.png)
...
![building voronoi in turfjs webpage](/using_var/turfjs.png)

4. Let's go back on geojson.io to see the result:
![see result](/using_var/geojsonio2.png)
